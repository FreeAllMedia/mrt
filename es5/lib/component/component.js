...
exports.PropertyCollection = undefined;
...
exports.PropertyCollection = _propertyCollection2.default;
...
var Component = function () {
	...
	_createClass(Component, [{
		...
		value: function properties() {
			...
			return this[externalFunction].apply(this, ["./component.properties.js"].concat(propertyNames));
		}
	}, {
		key: "propertyNames",
		...
		value: function link(methodName, LinkConstructor) {
			var newLink = new _link2.default(this, methodName, LinkConstructor);
