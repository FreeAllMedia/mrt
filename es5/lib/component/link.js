...
var Link = function () {
	function Link(parentLink, methodName, ComponentConstructor) {
		var _this = this;
	...
	_createClass(Link, [{
		...
		value: function value() {
			...
			var instance = new (Function.prototype.bind.apply(this.ComponentConstructor, [null].concat(_toConsumableArray(options))))();
			...
			if (_.inherit) {
				var inheritedPropertyNames = _.inherit;

				inheritedPropertyNames.forEach(function (propertyName) {
