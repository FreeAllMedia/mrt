...
describe("chainLink.parameterCollections()", function () {
	var person = void 0;
	...
	it("should create a parameter collection for each call to .parameters", function () {
		person.parameterCollections().length.should.eql(2);
	});

	it("should return an array of ParameterCollection", function () {
		person.parameterCollections()[0].should.be.instanceOf(_chainLink.ParameterCollection);
	});
});