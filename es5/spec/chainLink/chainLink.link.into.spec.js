...
describe("chainLink.link.into", function () {
	var person = void 0;
	...
	it("should return the connection so that chaining is possible", function () {
		var connection = person.link("badThought", Thought);
		var returnValue = connection.into("badThoughts");
