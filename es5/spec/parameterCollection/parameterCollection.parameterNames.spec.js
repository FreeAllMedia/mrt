...
describe("parameterCollection.parameterNames()", function () {
	var parentLink = void 0,
	    parameterNames = void 0,
	    parameterCollection = void 0;
	...
	beforeEach(function () {
		...
		parameterCollection = new _chainLink.ParameterCollection(parentLink, parameterNames);
	});

	it("should return this to enable chaining", function () {
		parameterCollection.parameterNames("something").should.eql(parameterCollection);
	});
	...
	it("should be settable", function () {
		var _parameterCollection;

		parameterNames = ["height", "width"];

		(_parameterCollection = parameterCollection).parameterNames.apply(_parameterCollection, _toConsumableArray(parameterNames));
		parameterCollection.parameterNames().should.eql(parameterNames);
	});
});