...
describe("component.propertyCollections()", function () {
	var person = void 0;
	...
	it("should return an array of PropertyCollection", function () {
		person.propertyCollections()[0].should.be.instanceOf(_component.PropertyCollection);
	});
});