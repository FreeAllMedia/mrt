...
describe("component.link.getter", function () {
	var person = void 0,
	    returnValue = void 0;
	...
	it("should return a new instance of the Component constructor when called", function () {
		returnValue.should.be.instanceOf(Thought);
	});

	it("should add the newly instantiated chain link to the links objects", function () {
